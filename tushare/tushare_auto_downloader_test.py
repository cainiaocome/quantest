...
def thread_07(thread_07_event, thread_06_event):
    ...
    '''
    ## @TODO neeeeed more test, critical thread 
...
if __name__ == '__main__':
    ...
    log.logger.info('tushare_auto_downloader_v2.0 start...')
    ...
    threads.append(threading.Thread(target=thread_16, args=(thread_16_event,)))
    # thread_17
    ...
    for t in threads:
        t.join()
    log.logger.info('tushare_auto_downloader_v2.0 end...')
