...
class TushareApiRsi():
    ...
    def calculate_rsi(self):
        ...
        today_all_roe_pb = pd.read_excel(io=self.working_folder + filename + '.xlsx')
        ...
        today_all_roe_pb.to_excel(self.working_folder + filename + '.xlsx', encoding='GBK')
        #try:
        #today_all_roe_pb.to_excel(r"~/Library/Mobile Documents/iCloud Drive/" + filename + '.xlsx', encoding='GBK')
        #except:
        #    pass
    ...
    def calculateHindenburgOmen(self, start='2018-01-01', end='2018-07-01', timeperiod=5):
        ...
        index_000001 = pd.read_excel(io=self.working_folder + filename + '.xlsx')
        index_000001.set_index(keys=['date'], inplace=True, drop=True)
        filename = 'index_399001'
        index_399001 = pd.read_excel(io=self.working_folder + filename + '.xlsx')
        index_399001.set_index(keys=['date'], inplace=True, drop=True)
        filename = 'index_399006'
        index_399006 = pd.read_excel(io=self.working_folder + filename + '.xlsx')
        ...
        filename = 'today_all_R_square' + '_' + end
        today_all_roe_pb.to_excel(self.working_folder + filename + '.xlsx', encoding='GBK')
        ...
        hindenburg_omen_row.iloc[0, 0] = end
