...
if __name__ == '__main__':
    ...
    year_start = 2005
    year_end = 2016
    period_3_start = '03-15'
    period_3_end = '04-15'

    start_date = str(year_start) + '-' + period_3_start
    end_date = str(year_end) + '-' + period_3_end
    ...
    print(result_df)
    result_df.to_csv('/Users/yanghui/Desktop/三月行情_2005_2016.csv')
